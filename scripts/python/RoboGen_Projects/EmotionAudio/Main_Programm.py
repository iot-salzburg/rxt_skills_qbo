...
# decision trees
sys.path.append('/opt/QBO/catkin_ws/src/rxt_skills_qbo/scripts/python/RoboGen_Projects/EmotionAudio/dt')
import DecisionTrees

# emotion analysis
sys.path.append('/opt/QBO/catkin_ws/src/rxt_skills_qbo/scripts/python/RoboGen_Projects/EmotionAudio/ea')
import EmotionAnalysis

# emergency trigger
sys.path.append('/opt/QBO/catkin_ws/src/rxt_skills_qbo/scripts/python/RoboGen_Projects/EmotionAudio/em')
import Emergency

# notif trigger
sys.path.append('/opt/QBO/catkin_ws/src/rxt_skills_qbo/scripts/python/RoboGen_Projects/EmotionAudio/not')
import Notif
...
# saved nutrition
sys.path.append('/opt/QBO/catkin_ws/src/rxt_skills_qbo/scripts/python/RoboGen_Projects/MyQBOFoodplan')
import FoodManager

# saved and uploaded calendar on server
sys.path.append('/opt/QBO/catkin_ws/src/rxt_skills_qbo/scripts/python/RoboGen_Projects/MyQBOCalendar')
