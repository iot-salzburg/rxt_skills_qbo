...
def loadDTData(area):
    ...
    with open('/opt/QBO/catkin_ws/src/rxt_skills_qbo/scripts/python/RoboGen_Projects/EmotionAudio/dt/json/robogen_decisiontrees.json', 'r') as dt_file:
...
def loadInterventionData(codeInput):
    ...
    with open('/opt/QBO/catkin_ws/src/rxt_skills_qbo/scripts/python/RoboGen_Projects/EmotionAudio/dt/json/robogen_interventions.json', 'r') as interventions_file:
